...
<div id="foodOrder_manage_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit-new" plain="true" onclick="foodOrder_manage_tool.edit();">发货</a>
...
<div id="foodOrderEditDiv">
	<form id="foodOrderEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<select id="foodOrder_orderState_edit" name="foodOrder.orderState" >
