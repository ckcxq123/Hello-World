		       ...
		       text: "宠物粮食管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Food/food_add.jsp"
			    	   	},
			    		{
			    	   		text: "宠物粮食管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Food/food_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "宠粮订单管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "FoodOrder/foodOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "宠粮订单管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "FoodOrder/foodOrder_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "领养管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Adopt/adopt_add.jsp"
			    	   	},
			    		{
			    	   		text: "领养管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Adopt/adopt_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
