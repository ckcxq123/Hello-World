...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">猫先生爱心宠物</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Pet/userFrontlist">宠物领养</a></li>
                <li><a href="<%=basePath %>Food/frontlist">宠物粮食</a></li>  
                <li><a href="<%=basePath %>Leaveword/frontlist">留言交流</a></li>
                <li><a href="<%=basePath %>Notice/frontlist">网站公告</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Adopt/frontUserlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的领养记录</a></li>
                        <li><a href="<%=basePath %>FoodOrder/frontUserlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的宠粮订单</a></li> 
                        <li><a href="<%=basePath %>UserInfo/userInfo_frontModify.jsp?user_name=<%=session.getAttribute("user_name") %>"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
                        <li><a href="<%=basePath %>index.jsp"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;返回首页</a></li>
                    </ul>
                </li>
