...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a class="pull-right" href="<%=basePath %>Pet/pet_frontAdd.jsp" >添加宠物</a></li>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="petQueryForm" id="petQueryForm" action="<%=basePath %>Pet/userFrontlist" class="mar_t15">
