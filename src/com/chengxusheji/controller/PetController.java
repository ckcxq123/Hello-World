...
public class PetController extends BaseController {
	...
	/*用户前台按照查询条件分页查询待领养宠物信息*/
	@RequestMapping(value = { "/userFrontlist" }, method = {RequestMethod.GET,RequestMethod.POST})
	public String userFrontlist(@ModelAttribute("petClassObj") PetClass petClassObj,String petName,String petState,String addTime,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (petName == null) petName = "";
		if (petState == null) petState = "";
		if (addTime == null) addTime = "";
